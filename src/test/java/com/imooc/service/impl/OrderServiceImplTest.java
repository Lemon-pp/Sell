...
public class OrderServiceImplTest {
    ...
    private final String BUYER_OPENID = "10746234";

    private final String ORDER_ID = "1576736629721923892";

    @Test
    public void create() {

        OrderDTO orderDTO = new OrderDTO();
        orderDTO.setBuyerName("小粥刘");
        orderDTO.setBuyerAddress("麓谷");
        orderDTO.setBuyerPhone("13788886666");
        orderDTO.setBuyerOpenid(BUYER_OPENID);

        List<OrderDetail> orderDetailList = new ArrayList<>();
        OrderDetail o1 = new OrderDetail();
        o1.setProductId("15635");
